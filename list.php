...
<div class="container">
    ...
    <?php
		...
		foreach ($result as $list) {
			...
			echo '<div class="viewmap"><a href="https://maps.google.com/maps?q='.$li->latitude.'+'.$li->longitude.'('.$li->title')"><button class="btn btn-primary" type="button">View Map</button></a></div>';
